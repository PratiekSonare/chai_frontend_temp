    ...
    return (
        <div className='z-11 oswald flex flex-row items-center justify-center gap-10 w-full'>
            ...
            <div className='flex flex-row gap-3 w-2/3'>
                <button onClick={() => router.push('/orders')} className='p-2 w-full !rounded-lg bg-blue-100 border border-blue-600 text-blue-600 text-center'>
                    ORDERS
                </button>
                <button onClick={() => router.push('/profit')}  className='p-2 w-full !rounded-lg bg-gray-100 border-2 border-dashed border-gray-300 text-gray-400 text-center'>
                    PROFITABILITY
                </button>
