      ...
      <div className="relative searchCard example-2 w-full">
        <div className="inner border border-blue-300 h-20">
          <div className='p-2 flex flex-row gap-5 items-center justify-center h-full'>
            ...
            <button className={`${isError ? "animate-pulse" : "animate-none"} h-full flex w-1/6 items-center justify-center text-white bg-[#0019B1] !rounded-xl scale-100 active:scale-95 transition-all duration-100`}
