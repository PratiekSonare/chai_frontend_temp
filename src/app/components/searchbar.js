export default function Searchbar({ searchbarRef, placeholder, inputValue, setInputValue, onSearch }) {
  ...
  return (
    <div ref={searchbarRef} className="searchCard example-2" style={{ width: '60%' }}>
      <div className="inner border border-blue-300 w-full h-20">
        <div className='p-2 flex flex-row items-center justify-center h-full'>
          <svg className='w-8 ml-2' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <input 
            className="flex-10/12 focus:outline-none !ml-4 poppins !text-lg transition-all duration-300" 
