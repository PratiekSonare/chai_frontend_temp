    ...
    >
      ...
      >
        ...
        {isOpen && (
          <div
            className={cn(
              `absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-2 grid-rows-2 rounded-b-xl gap-3 justify-center items-center p-5`,
              cN,
            )}
          >
      ...
      <div className="flex flex-row justify-between w-full">
        <div className="grid grid-cols-2 grid-rows-2 w-1/2 h-full gap-0">
          ...
          >
            ...
            <span className={cn("text-3xl poppins font-bold", textCn)}>
              {data[0]}
            </span>
          </button>
          <button
          ...
          >
            <span className={cn(`text-md poppins font-bold`, opacityCn)}>
              {titles[1].title}
            </span>
            <span
              className={cn("text-3xl poppins font-bold", textCn, opacityCn)}
            >
              {data[1]}
            </span>
          </button>
