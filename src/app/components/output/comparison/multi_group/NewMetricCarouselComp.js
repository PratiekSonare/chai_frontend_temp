...
export default function NewMetricCarouselComp({
  searchData,
  isSuccess,
  cN = "bg-[#001FB0]",
}) {
  ...
  const currentWinnerState = useMemo(() => {
    switch (defaultWinner) {
      case "one":
        return winnerByVolume;
      case "two":
        return winnerByRevenue;
      case "three":
        return winnerByAov;
      default:
        return winnerByVolume;
                ...
                >
                  <div className="flex flex-col !gap-0">
                    ...
                    <span className="poppins text-xs italic text-gray-300">
                      Compare different groups by volume, revenue, and average
                      order value to identify top performers
                    </span>
                  </div>
                </div>
              )}
              <svg
                className="h-4 px-4 transition-transform duration-200 ease-in"
                viewBox="0 0 24 24"
                fill="none"
              ...
              {isOpen && (
                ...
                >
                  <div className="flex flex-col !gap-0">
                    ...
                    <span className="poppins text-xs italic text-gray-300">
                      Compare total number of orders across different groups to
              ...
              <div className="w-full flex flex-row">
                {Object.entries(groupSummaries).map(
                  ([groupName, data], index) => {
                    ...
                    const borderClass =
                      index < Object.keys(groupSummaries).length - 1
                    ...
                    return (
                      <button
                        key={groupName}
                        className={`p-5 w-full ${borderClass} ${radiusClass} text-center flex flex-col items-center justify-center ${
                          isHighest
          ...
          >
            ...
            >
              ...
              {isOpen && (
                <div
                  className={cn(
                    `bg-green-600 absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-2 grid-rows-2 rounded-b-xl gap-3 justify-center items-center p-5`,
                  )}
                >
                  <div className="flex flex-col !gap-0">
                    <span className="poppins text-sm font-extrabold text-white">
                    ...
                    <span className="poppins text-xs italic text-gray-300">
                      Compare total revenue generated across different groups to
                  ...
                  ([groupName, data], index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`font-bold rounded-full w-8 h-8 text-md flex items-center justify-center ${
                            isHighest ? "text-green-600 bg-white" : "text-white"
                          }`}
                          style={!isHighest ? { backgroundColor: bgColor } : {}}
                        >
                          <span>{index + 1}</span>
          ...
          >
            ...
            >
              ...
              {isOpen && (
                <div
                  className={cn(
                    `bg-purple-600 absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-2 grid-rows-2 rounded-b-xl gap-3 justify-center items-center p-5`,
                  )}
                >
                  <div className="flex flex-col !gap-0">
                    <span className="poppins text-sm font-extrabold text-white">
                    ...
                    <span className="poppins text-xs italic text-gray-300">
                      Compare average order values across groups to identify
