...
export default function MetricCarousel({
  ...
  const winner_by_volume =
    searchData.comparison_data.winner_by_volume ||
    searchData.comparison_data.winner_by_margin;
  const winner_by_revenue =
    searchData.comparison_data.winner_by_revenue ||
    searchData.comparison_data.winner_by_total_profit;
  const winner_by_aov =
    searchData.comparison_data.winner_by_avg_value ||
    searchData.comparison_data.winner_by_markup;
  ...
  const currentWinnerState = useMemo(() => {
    switch (defaultWinner) {
      case "one":
        return winner_by_volume;
      case "two":
        return winner_by_revenue;
      case "three":
        return winner_by_aov;
      default:
        return winner_by_volume;
    }
  ...
  const mapData = useMemo(() => {
    ...
    return [
      {
        name:
          currentWinnerState.charAt(0).toUpperCase() +
          currentWinnerState.slice(1).toLowerCase(),
        value: 1,
        color: "#001FB0",
      },
    ];
    ...
    >
      <CarouselContent className="!h-full">
        ...
        <CarouselItem className="basis-1/2">
          <div
            className="pointer-events-auto select-none relative rounded-xl bg-gray-100 border border-blue-200 w-full !h-fit"
          ...
          >
            <div
              ...
              className={cn(
                "flex flex-row items-center justify-between rounded-t-xl h-fit cursor-pointer",
                cN,
              )}
            >
              <span className="block text-md py-2 px-4 text-white rounded-t-xl oswald">
                WINNER BY
              </span>
              {isOpen && (
                <div
                  className={cn(
                    `${cN} absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-2 grid-rows-2 rounded-b-xl gap-3 justify-center items-center p-5`,
                  )}
                >
                  <div className="flex flex-col !gap-0">
                    ...
                    <span className="poppins text-xs italic text-gray-300">
                      Compare two groups head-to-head by{" "}
                      {isProfit
                        ? "margin, profit, and markup"
                        : "volume, revenue, and average order value"}
                    </span>
                  </div>
                </div>
              )}
              <svg
                className={`${isOpen ? "rotate-180" : "rotate-0"} h-4 px-4 transition-transform duration-200 ease-in`}
                viewBox="0 0 24 24"
                fill="none"
            ...
            <div className="flex flex-row justify-between w-full oswald">
              <div className="w-1/3 h-fit flex flex-col gap-0">
                <button
                  ...
                  className={`p-2 border-r-2 border-b-2 border-gray-400 w-full text-center flex items-center gap-2 ${
                    defaultWinner === "one" ? "bg-[#001FB0] text-white" : ""
                  }`}
                >
                  <div
                    className={`font-bold rounded-full w-8 h-8 text-md flex items-center justify-center ${
                      defaultWinner === "one"
                ...
                <button
                  ...
                  className={`p-2 border-r-2 border-b-2 border-gray-400 w-full text-center flex items-center gap-2 ${
                    defaultWinner === "two" ? "bg-[#001FB0] text-white" : ""
                  }`}
                >
                  <div
                    className={`font-bold rounded-full w-8 h-8 text-md flex items-center justify-center ${
                ...
                <button
                  ...
                  className={`p-2 border-r-2 border-gray-400 w-full text-center flex items-center gap-2 ${
                    defaultWinner === "three" ? "bg-[#001FB0] text-white" : ""
                  }`}
                >
                  <div
                    className={`font-bold rounded-full w-8 h-8 text-md flex items-center justify-center ${
        ...
        <CarouselItem className="basis-1/2">
          <div
            className="pointer-events-auto select-none relative rounded-xl bg-gray-100 border border-orange-200 w-full !h-fit"
            onClick={() => setIsOpen(false)}
          >
            <div
              onClick={(e) => {
            ...
            >
              ...
              {isOpen && (
                <div
                  className={cn(
                    `bg-orange-600 absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-2 grid-rows-2 rounded-b-xl gap-3 justify-center items-center p-5`,
                  )}
                >
                  <div className="flex flex-col !gap-0">
                    <span className="poppins text-sm font-extrabold text-white">
                    ...
                    <span className="poppins text-xs italic text-gray-300">
                      ...
                      {isProfit ? "items in each group" : "order volumes"} with
              ...
              <div className="w-2/3 flex flex-row">
                ...
                >
                  ...
                  <span className="text-sm capitalize">
                    {searchData.comparison_data.groups.a}
                  </span>
                </button>
                ...
                >
                  ...
                  <span className="text-sm capitalize">
                    {searchData.comparison_data.groups.b}
                  </span>
                </button>
              </div>
              ...
              <div className="w-1/3 flex flex-col">
                ...
                >
                  ...
                  <span className="text-2xl mx-auto ">
                    {isProfit
                      ? searchData.comparison_data.item_count?.diff || 0
                      : searchData.comparison_data.order_count.diff.toFixed(2)}
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-2xl mx-auto">
                    {isProfit
                      ? (
                          searchData.comparison_data.item_count?.diff_pct || 0
                        ).toFixed(1)
                      : searchData.comparison_data.order_count.diff_pct.toFixed(
                          2,
                        )}
                  </span>
                </button>
        ...
        <CarouselItem className="basis-1/2">
          <div
            className="pointer-events-auto select-none relative rounded-xl bg-gray-100 border border-green-200 w-full !h-fit"
            onClick={() => setIsOpen(false)}
          >
            <div
              onClick={(e) => {
            ...
            >
              ...
              {isOpen && (
                <div
                  className={cn(
                    `${getRevenueColor()} absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-2 grid-rows-2 rounded-b-xl gap-3 justify-center items-center p-5`,
                  )}
                >
                  <div className="flex flex-col !gap-0">
                    <span className="poppins text-sm font-extrabold text-white">
                      {getRevenueLabel()} Comparison
                    </span>
                    <span className="poppins text-xs italic text-gray-300">
                      Head-to-head {isProfit ? "profit" : "revenue"} comparison
                      between two groups showing totals and percentage
                      differences
                    </span>
                  </div>
                </div>
              ...
              <div className="w-1/3 flex flex-col">
                ...
                >
                  ...
                  <span className="text-2xl mx-auto">
                    ...
                    {formatRevenue(
                      Math.abs(
                        isProfit
                          ? searchData.comparison_data.total_gross_profit?.diff
                          : searchData.comparison_data.total_revenue.diff,
                      ),
                    )}
                  </span>
                </button>
                ...
                >
                  ...
                  <span className="text-2xl mx-auto">
                    {Math.abs(
                      isProfit
                        ? searchData.comparison_data.total_gross_profit
                            ?.diff_pct
                        : searchData.comparison_data.total_revenue.diff_pct,
                    ).toFixed(1)}
                    %
                  </span>
                </button>
        ...
        <CarouselItem className="basis-1/2">
          <div
            className="pointer-events-auto select-none relative rounded-xl bg-gray-100 border border-purple-200 w-full !h-fit"
            onClick={() => setIsOpen(false)}
          >
            <div
              onClick={(e) => {
            ...
            >
              ...
              {isOpen && (
                <div
                  className={cn(
                    `${getAvgColor()} absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-2 grid-rows-2 rounded-b-xl gap-3 justify-center items-center p-5`,
                  )}
                >
                  <div className="flex flex-col !gap-0">
                    <span className="poppins text-sm font-extrabold text-white">
                      {getAvgLabel()} Comparison
                    </span>
                    <span className="poppins text-xs italic text-gray-300">
                      Compare{" "}
                      {isProfit
            ...
            <div className="flex flex-row justify-between w-full oswald">
              <div className="w-2/3 flex flex-row">
                ...
                >
                  ...
                  <span className="text-3xl mt-3">
                    {avg_metric_a.toFixed(isProfit ? 2 : 0)}
                    {isProfit ? "%" : ""}
                  </span>
                  <span className="text-sm capitalize">
                    {searchData.comparison_data.groups.a}
                ...
                >
                  ...
                  <span className="text-3xl mt-3">
                    {avg_metric_b.toFixed(isProfit ? 2 : 0)}
                    {isProfit ? "%" : ""}
                  </span>
                  <span className="text-sm capitalize">
                    {searchData.comparison_data.groups.b}
              ...
              <div className="w-1/3 flex flex-col">
                ...
                >
                  ...
                  <span className="text-2xl mx-auto">
                    {Math.abs(
                      isProfit
                        ? searchData.comparison_data.avg_gross_margin?.diff
                        : searchData.comparison_data.avg_order_value.diff,
                    ).toFixed(isProfit ? 2 : 0)}
                    {isProfit ? "%" : ""}
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-2xl mx-auto">
                    {Math.abs(
                      isProfit
                        ? searchData.comparison_data.avg_gross_margin?.diff_pct
                        : searchData.comparison_data.avg_order_value.diff_pct,
                    ).toFixed(1)}
                    %
                  </span>
                </button>
