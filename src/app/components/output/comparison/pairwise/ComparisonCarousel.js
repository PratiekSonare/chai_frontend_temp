      ...
      <CarouselContent className="!h-fit">
        ...
        {!isProfit && (
          <CarouselItem className="basis-full">
            <div
              className="relative flex items-center justify-center w-full h-full rounded-xl border-4 border-[#0024af]"
            ...
            >
              <div
                ...
                className="absolute top-0 right-0 rounded-bl-xl px-3 py-2 bg-[#0024af] oswald text-white cursor-pointer z-10"
              >
                MAP
                {isOpen && (
                  <div
                    className={cn(
                      `bg-[#0024af] absolute top-10 right-0 left-[-200px] bottom-[-200px] z-50 grid grid-cols-1 rounded-b-xl gap-3 justify-center items-center p-5`,
                    )}
                  >
                    <div className="flex flex-col !gap-0">
                      ...
                      <span className="poppins text-xs italic text-gray-300">
                        Visual representation of data comparison across
        ...
        {isProfit &&
          searchData?.detailed_metrics &&
          Object.entries(searchData.detailed_metrics).map(
            ([groupName, groupMetrics], index) => (
                ...
                >
                  ...
                  >
                    ...
                    {isOpen && (
                      <div
                        className={cn(
                          `bg-[#001FB0] absolute top-10 left-0 right-0 bottom-0 z-50 grid grid-cols-1 rounded-b-xl gap-3 justify-center items-center p-5`,
                        )}
                      >
                        <div className="flex flex-col !gap-0">
                          <span className="poppins text-sm font-extrabold text-white">
                          ...
                          <span className="poppins text-xs italic text-gray-300">
                            Detailed profit metrics for {groupName} style
                            including margin, profit, and other indicators
                          </span>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-3">
                      ...
                      <div className="p-2 flex flex-col items-center justify-center text-center border-r-2 border-b-2 border-gray-400">
                        <div className="text-xl font-bold text-green-600">
                          ₹
                          {groupMetrics.summary?.total_gross_profit?.toFixed(
                            0,
                          ) || 0}
                        </div>
                        <div className="text-sm text-gray-600 poppins">
                      ...
                      <div className="p-2 flex flex-col items-center justify-center text-center border-b-2 border-gray-400">
                        <div className="text-xl font-bold text-purple-600">
                          {groupMetrics.summary?.avg_gross_margin?.toFixed(2) ||
                            0}
                          %
                        </div>
                        <div className="text-sm text-gray-600 poppins">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-indigo-600">
                            {groupMetrics.summary?.avg_markup_percent?.toFixed(
                              2,
                            ) || 0}
                            %
                          </span>
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-orange-600">
                            {(
                              groupMetrics.items?.[0]?.cost_to_price_ratio || 0
                            ).toFixed(2)}
                            %
                          </span>
                        </div>
                        ...
                        {groupMetrics.items.map((item, idx) => (
                          ...
                          >
                            ...
                            <div className="flex justify-between text-xs text-gray-600 mt-1">
                              <span>
                                Margin: {item.gross_margin?.toFixed(2)}%
                              </span>
                              <span>
                                Profit: ₹{item.gross_profit?.toFixed(0)}
                              </span>
                            </div>
                          </div>
                        ))}
                ...
                >
                    ...
                    {isOpen && (
                      ...
                      >
                        <div className="flex flex-col !gap-0">
                          ...
                          <span className="poppins text-xs italic text-gray-300">
                            Detailed metrics breakdown showing orders, revenue,
                            AOV, payment modes, and geographic distribution for{" "}
                            {stateName}
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="space-y-2 poppins">
                    ...
                    <div className="grid grid-cols-3">
                      ...
                      <div className="p-2 flex flex-col items-center justify-center text-center border-b-2 border-gray-400">
                        <div className="text-xl font-bold text-purple-600">
                          ₹{metrics.avg_order_value?.toFixed(2)}
                        </div>
                      ...
                      <div className="w-full h-30 flex justify-center items-center relative">
                        <canvas
                          ref={(el) => {
                            if (el) {
                              setTimeout(
                                () =>
                                  createPaymentChart(el, metrics, stateName),
                                100,
                              );
                            }
                          }}
                        ...
                        <div className="absolute bottom-2 flex items-center justify-center pointer-events-none">
                          <div className="text-center">
                            ...
                            <div className="text-sm text-gray-500 poppins">
                              TOTAL
                            </div>
                          </div>
                        </div>
