...
export default function CustomMetricGeneration({
  metric_analysis,
  metric_calculated,
}) {
          ...
          >
            ...
            {isOpen && (
              ...
              >
                <div className="flex flex-col !gap-0">
                  ...
                  <span className="poppins text-xs italic text-gray-300">
                    Single calculated metric result for the current query
                  </span>
                </div>
              </div>
            )}
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                ></path>{" "}
                <path
                  d="M19 13L12.7071 19.2929C12.3166 11.6834 11.6834 11.6834 11.2929 19.2929L5 13"
                  stroke="#fff"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
