        ...
        <div className="poppins w-[90%] h-screen">
            <div className="flex flex-col gap-10 items-start justify-center w-full h-full">
                ...
                <div className="flex flex-row w-full h-2/3 justify-center items-center gap-5">
                    ...
                    <Dialog>
                        <DialogTrigger className="w-full h-full flex flex-col gap-5 group items-center justify-center rounded-xl border border-dashed border-gray-600 text-gray-600 bg-gray-50 hover:bg-gray-300 opacity-50 hover:opacity-100 transition-opacity duration-100 ease-in-out">
