...
export default function DayComparisonCard() {
  ...
  const selectedPreset = useMemo(
    () =>
      QUICK_LINKS.find((link) => link.id === selectedQuickLink) ||
      QUICK_LINKS[0],
    [selectedQuickLink],
  );
  ...
  useEffect(() => {
    ...
    const maxValue =
      d3.max(chartRows.flatMap((d) => [d.current, d.previous])) || 0;
    const y = d3
      .scaleLinear()
  ...
  useEffect(() => {
    ...
    g.selectAll("text.delta-label")
      ...
      .attr("x", (d) =>
        d.deltaPct >= 0 ? x(d.deltaPct) + 6 : x(d.deltaPct) - 6,
      )
    ...
    <div className="w-[90%] h-screen flex flex-col justify-center items-start gap-10">
      <div className="flex flex-col items-start text-left">
        ...
        <span className="poppins text-lg text-gray-500">
          Compare weekly & monthly order data and discover trends.
        </span>
      </div>
      ...
      <div className="poppins w-[96%] h-3/4">
        <div className="relative h-full bg-[#001a8e] rounded-xl flex flex-col gap-0 overflow-hidden">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-sm text-white/80">
                  Use presets for instant trend checks or switch to a custom
                  range.
                </span>
              </div>
          ...
          <div className="w-full h-4/5 flex flex-col xl:flex-row gap-5 p-5">
            <div className="h-full xl:w-1/2 bg-zinc-50 rounded-xl border border-black p-5 flex flex-col">
            ...
            <div className="xl:w-1/2 h-full bg-zinc-50 rounded-xl border border-black p-5 flex flex-col">
              <div className="flex items-center justify-between mb-2">
                <span className="font-semibold text-slate-800">
                  Growth Delta
                </span>
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                {chartRows.map((item) => (
                  ...
                  >
                    ...
                    <p
                      className={`text-sm font-semibold ${item.deltaPct >= 0 ? "text-emerald-600" : "text-rose-600"}`}
                    >
